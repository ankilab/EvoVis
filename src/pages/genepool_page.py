...
def cytoscape_stylesheet(groups):
    ...
    cytoscape_stylesheet = [
        ...
        {"selector": "edge", "style": {"line-color": "#6173E9", "width": "2px"}},
        {
            "selector": "label",
            "style": {
...
def gene_overview():
    ...
    return html.Div(
        [
            ...
            html.Img(
                src="assets/media/gene-overview-img.png",
                height="250px",
                id="gene-overview-img",
            ),
        ],
...
def genepool_layout():
    ...
    if validation_result:
        layout = html.Div(children=[genepool_header(), warning(validation_result)])
        ...
        layout = dmc.Grid(
            children=[
                ...
                dmc.Col(
                    cytoscape_search_space(), span="auto", style={"min-width": "525px"}
                ),
            ],
            gutter="l",
        )

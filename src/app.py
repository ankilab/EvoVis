...
def navbar():
    ...
    nav_items = [
        {
            "desc": "Parameters Overview",
            "icon": "streamline:input-box-solid",
                    ...
                    html.A(
                        html.Button(
                            children=DashIconify(
                                icon=item["icon"], height=25, width=25, color="#000000"
                            ),
        ...
        [
            html.Div(
                [
                    html.A(
                        children=html.Img(
                            src="assets/media/evonas-logo.png", height="50px"
                        ),
                        href=dash.page_registry["pages.hyperparameters_page"][
                            "relative_path"
                        ],
                    )
                ],

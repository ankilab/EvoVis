        ...
        [
            ...
            html.Div(
                [
                    html.P(
                        metrictype,
                        style=metric_type_style,
                        id=f"{metric_card_id}-label",
                    ),
                    html.H4(
                        metric if unit is None else f"{metric} {unit}",
                        style=metric_style,
                        id=f"{metric_card_id}-value",
                    ),
                ],
...
def bullet_chart_card(
    ...
    if constraint is not None:
        ...
        if constraint_percent > 100:
            constraint_percent = 100
        if constraint_percent < 0:
            constraint_percent = 0
        ...
        [
            ...
            html.Div(
                [
                    ...
                    html.Div(
                        [
                            html.Div([], style=load_style),
                            html.Div([], style=constraint_style),
                        ],
                        style=bar_style,
                    ),
                ],
...
def bullet_chart_card_basic(
    ...
    flex="100%",
    min_width=None,
    metric_card_id="bullet-chart-basic",
):
    """
...
def warning(message):
    ...
    """
    children = [
        DashIconify(icon="mingcute:information-line", height=25, width=25),
        html.P(message, className="feedback-text"),
    ]
...
def fitness_function():
    ...
    img_style = {"max-width": "100%", "max-height": "40px", "margin": "10px"}
    ...
    description_style = {"display": "inline-flex", "flex-grow": "1", "margin": "5px"}

    fitness_function_div = dmc.Grid(
        [
            html.Div(
                html.Img(src=f"assets/media/fitness-function.png", style=img_style),
                ...
                [
                    html.Div(
                        [
                            ...
                            html.H4("a b c", style={"margin": "5px"}),
                        ]
                    ),
                    html.Div(
                        [
                            ...
                            html.H4("M T W", style={"margin": "5px"}),
                        ]
                    ),
                ],
